...
2. **Creation**: For any new problem that isn't in the local database, it looks for a `customer` tag in Zabbix, finds the matching company in Autotask, and creates a ticket. If no matching company is found, the alert is ignored.
